        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.siswa.create') }}" class="btn btn-primary">Create Siswa</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($siswas as $key => $siswa)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.siswa.show', $siswa->id) }}"
                                                class="btn btn-info"><i class="fas fa-eye"></i> View</a>
                                            <a href="{{ route('admin.siswa.edit', $siswa->id) }}"
                                                class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
                                            <button onClick="destroy(this.id)" id="{{ $siswa->id }}"
